...
class Actions:
    ...
    def on_x_press(self):
        ...
        button = 1
        total = button.to_bytes(1, 'big')
        print("x: {}".format(total))
    ...
    def on_L3_up(self, value):
        #conversion = (int)(-1 * (value / 256))
        #conversion_bytes = conversion.to_bytes(1, 'big')
        #self.ser.write(conversion_bytes) Prints it on the lcd
        if value < -26000: 
            conversion = 5  
            total = conversion.to_bytes(1, 'big')
            self.ser.write(b'\x05')
            print("on_L3_up: {}".format(total))

    def on_L3_down(self, value):
        #conversion = (int)(value / 256)
        #conversion_bytes = conversion.to_bytes(1, 'big')
        #self.ser.write(conversion_bytes)
        if value > 26000: 
            conversion = 7  
            total = conversion.to_bytes(1, 'big')
            self.ser.write(b'\x07')
            print("on_L3_down: {}".format(total))
    ...
    def on_L3_right(self, value):
        ...
        if value > 26000: 
            ...
            total = conversion.to_bytes(1, 'big')
            print("on_L3_right: {}".format(total))
    ...
    def on_R3_right(self, value):
        ...
        if value > 25500: 
            ...
            total = conversion.to_bytes(1, 'big')
            print("on_R3_right: {}".format(total))
